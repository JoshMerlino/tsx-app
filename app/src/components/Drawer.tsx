...
export default function Drawer(): JSX.Element {
	...
	return (
		<>
			...
			<aside className={ classnames("bg-white dark:bg-zinc-700 ease-in-out w-[300px] fixed top-0 h-full z-[10] shadow-md transition-[opacity,left] xl:transition-none xl:left-0", open ? "left-0" : "left-[-300px]") }>
