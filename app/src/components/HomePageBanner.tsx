		...
		<>
			<div className="pt-16 min-h-[440px] sticky overflow-hidden z-[3]" ref={ banner }>
				...
				<div className="mx-auto flex min-w-[369px] max-w-[80%] lg:max-w-[90%] w-[1280px] z-[4] relative flex-wrap">
					<img src={ icons.filter(icon => icon.purpose.includes("maskable"))[0].src } alt="" className="backdrop-blur-lg bg-neutral/60 select-none rounded-full bg-black/10 max-h-[192px] mx-auto lg:mx-4" />
					<div className="mx-auto lg:mx-14 my-1">
						<h1 className="text-4xl text-white py-3 inline-block">{ APP_MANIFEST.name }</h1>
